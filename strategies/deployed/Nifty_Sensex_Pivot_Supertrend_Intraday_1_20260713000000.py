...
class StrategyEngine:
    def __init__(self, client, store: StateStore, env: Environment, price_stream: "PriceStream",
        ...
        # 2026-08-04) is the same blocking-bug class check_force_exit is
        # already backgrounded against above: a slow/contended loopback call
    ...
    def _finalize_exit(self, leg_key: str, inst: InstrumentConfig, reason: str):
        ...
        # entirely). A "Manually Completed" exit resolution sets
        # manual_exit_px -- the user's real fill price is authoritative
        # there, not a fresh quote (see
        # docs/prd/python-strategies-order-error-recovery.md). Next,
