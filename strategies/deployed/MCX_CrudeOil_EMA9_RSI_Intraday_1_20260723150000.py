...
class LegPosition:
    ...
    quantity: int = 0
    entry_time: str = ""
    entry_px: float = 0.0          # LTP-based estimate at order-placement time; _watch_entry_fill
                                    # corrects this to the real broker fill once confirmed (2026-08-18)
                                    # -- the exit decision itself never looks at price.
    entry_order_id: str = ""
